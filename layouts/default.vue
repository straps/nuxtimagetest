  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-xl sm:text-2xl leading-7 font-semibold">
          Welcome to Nuxt Image!
        </h2>
        <p class="mt-3 text-gray-600">
          Feel free to check out the full
          <a
            ...
            >documentation</a
          >
          to see everything you can do.<br />
        </p>
        <div class="block my-4 border-b" />
        <nuxt />
        <div class="block my-4 border-b" />
        <p class="mt-3 text-gray-600">
          You can edit the props or the
          <a
            href="https://image.nuxtjs.org/components/nuxt-picture"
            target="_blank"
            class="text-green-500 hover:underline"
            >&lt;nuxt-picture&gt;</a
          >
          component in sandbox to see what you can do. Have fun!
        </p>
      </div>
      <!-- Footer -->
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/nuxt/image" target="_blank">
          <!-- Github Icon -->
          <svg
